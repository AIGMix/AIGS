    ...
    public class AESHelper
    {
        ...
        public static string Encrypt(string text, string key, string iv)
        {
...

            {
                ...
                byte[] bkey  = Encoding.UTF8.GetBytes(key).Take(32).ToArray();
                byte[] biv   = Encoding.UTF8.GetBytes(iv).Take(32).ToArray();
                byte[] bret  = Decrypt(btext, bkey, biv);
...
    }
    ...
    public class AES_CTR : IDisposable
    {
        /// <summary>
